...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','adventure-lite');?> <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/travel/');?>" target="_blank">
        <?php esc_html_e('SKT Travel Themes','adventure-lite'); ?>
        </a>
        </div>
     <div class="clear"></div>
</div>           
